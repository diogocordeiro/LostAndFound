            ...
            <div class="row">
              ...
              <div class="col-md-8 col-md-offset-2">
                ...
                <div class="card card-adicionar-item">
                  ...
                  <h5 class="description descricao-adicionar-item">Você pode editar as informações do seu report</h5>
                          ...
                          <div class="content">
                            ...
                            <i class="material-icons">label</i>
                                ...
                                <i class="material-icons">label</i>
                                    ...
                                    <textarea name="caracteristicas" class="form-control" placeholder="Caracteristicas únicas... Ex: arranhoes, amaçados, adesivos, etc." rows="5">
                                ...
                                <i class="material-icons">label</i>
                                    ...
                                    <textarea name="descricao" class="form-control" placeholder="Escreva uma pequena DESCRIÇÃO do item. Você pode informar algumas de suas principais caracteristicas..." rows="10">
                                      <?php echo $dados[0]['descricao']; ?>
                                    </textarea>
                                  </div>
                                  ...
                                  <i class="material-icons">label</i>
                                    ...
                                    <textarea name="informacao" class="form-control" placeholder="Escreva um pequeno texto sobre a situação onde o item foi encontrado. Ex: Econtrei sobre um banco de madeira, que fica na estação de metro N 22, era domingo a tarde, aproximadamente 15h" rows="10">
                                      <?php echo $dados[0]['informacao']; ?>
                                    </textarea>
                                  </div>
                                  ...
                                  <div class="input-group btn-upload-imagem">
                                    <?php echo '<input type="hidden" name="enderFotoAtual" value="'.$dados[0]['enderFoto'].'"/>'; ?>
                                      <label class="btn btn-md btn-default btn-cor-estilo-escuro"><i class="material-icons">file_upload</i> Imagem
                                        <input type="file" name="enderFoto" id="enderFoto">
                                      </label>
