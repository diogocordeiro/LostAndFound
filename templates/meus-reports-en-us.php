        ...
        <?php
            ...
            if (isset($_GET['remove'])) {
              ...
              if (count($dadosReportA) < 1 && count($dadosReportP) < 1) {
                echo "<center><br/><br/><br/><h4> Erro:  Report not found </h4><br/><a href='javascript:history.go(-1);'>back</a></center>";
                exit;
              ...
              //Caso o report exista
                  ...
                  //Caso o report perteca ao usuario da session
                       ...
                       && $dadosItemReport[0]['idRelAchado'] == 0
                        ...
                        if ($sucessoItem == "sucesso") {
                          $sucessoReport = removeReport(BaseDados::conBdUser(), $dadosReport[0]['id'], $tabRemover);
                            ...
                            echo "<h4> Deleting the Report. </h4>";
                          }
                      ...
                      if ($sucessoReport == "sucesso") {
                        echo "<center><br/><br/><br/> <h4> Report removed successfully. </h4><br/><a href='javascript:history.go(-1);'>back</a></center>";
                        exit;
                      } else {
                          echo "<center><br/><br/><br/><h4> Report not removed. </h4><br/><a href='javascript:history.go(-1);'>back</a></center>";
                          exit;
                        }
                    }
                }//else report exista
          ...
          ?>
        <h2 class="title titulo-busca">My Reports</h2>
