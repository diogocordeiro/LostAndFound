...
<body>
  ...
  <?php
    ...
    if(isset($_GET['id'])){
      ...
      if (count($dados) == 0) {
        echo "<br/><br/><br/><center><p><h4> Erro:  Item not found </h4></p><br/><a href='javascript:history.go(-1);'>voltar</a></center>";
        exit;
    ...
    //Caso a variavel id nao seja informada
        ...
        echo "<br/><br/><br/><center><p><h4> Erro: Enter item ID <h4></p><br/><a href='javascript:history.go(-1);>voltar</a></center>";
        exit;
      }
  ?>
            ...
            <div class="row">
              ...
              <div class="col-md-6 ">
                ...
                <div class="footer text-center">
                    <a class="btn-salvar btn btn-default  btn-lg btn-cor-estilo-escuro" href="form-editar-item.php?id=<?php echo $dados[0]['id'];?>">Edit Item</a>
                    <a class="btn-salvar btn btn-default  btn-lg btn-cor-estilo-escuro" href="meus-itens.php">My Items</a>
