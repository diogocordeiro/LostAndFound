...
<body>
  ...
  <?php
    ...
    if(isset($_GET['id'])){
      ...
      if (count($dados) == 0) {
        echo "<center>Erro: Report not found<br/><a href='javascript:history.go(-1);'>voltar</a></center>";
        exit;
    ...
    //Caso a variavel id nao seja informada
        ...
        echo "<center>Erro: Enter report ID<br/><a href='javascript:history.go(-1);>voltar</a></center>";
        exit;
      }
  ?>
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
              ...
              <div class="card card-adicionar-item">
                ...
                <h2 class="title titulo-adicionar-item">Edit Report</h2>
                        ...
                        <div class="col-md-8 col-md-offset-2 ">
                          ...
                          <div class="row">
                            ...
                            <div class="input-group input-size-small-device">
                              ...
                              <textarea name="informacao" class="form-control" placeholder="Write a short text about the situation where the item was found. Ex: I was on a wooden bench, which is in metro station N 22, Sunday afternoon, approximately 3pm" rows="10"><?php echo $dados[0]['informacao']; ?></textarea>
                            </div>
                            ...
                            <div class="input-group input-size-small-device">
                              ...
                              <input value="<?php echo $dados[0]['data']; ?>" id="horaItem" id="dataItem" name="dataItem"  type="date" class=" form-control input-lg " placeholder="Date..." required />
                            </div>
                            ...
                            <div class="input-group input-size-small-device">
                              ...
                              <input value="<?php echo $dados[0]['hora']; ?>" id="horaItem" name="horaItem" type="text" class=" form-control input-lg " placeholder="Time..." required />
                            </div>
                           ...
                           <script>
                            ...
                            <div class="input-group input-size-small-device">
                              <input value="<?php echo $dados[0]['mapsLocal']; ?>" id="autocomplete" name="autocomplete" class=" form-control input-lg " placeholder="Address" onload="geolocate()" type="text" size="50" required></input>
                            </div>
                            ...
                            <div class="input-group btn-upload-imagem">
                              ...
                              <label class="btn btn-md btn-default btn-cor-estilo-escuro"><i class="material-icons">file_upload</i>
                                Picture <input type="file" name="enderFoto" id="enderFoto">
                              </label>
