        ...
        <div class="row">
          ...
          <div class="col-md-8 col-md-offset-2">
            ...
            <div class="card card-adicionar-item">
              ...
              <h2 class="title titulo-adicionar-item">Profile</h2>
              ...
              <form class="form" id="edit-profile-form" enctype="multipart/form-data">
                ...
                <div class="content">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8 col-md-offset-2 ">
                      ...
                      <div class="input-group input-size-small-device">
                        ...
                        <input value="<?php echo $dados[0]['nome']; ?>" type="text" name="nome" id="nome" class=" form-control input-lg " placeholder="First Name..." />
                      ...
                      <div class="input-group input-size-small-device">
                        ...
                        <input value="<?php echo $dados[0]['sobrenome']; ?>" type="text" name="sobrenome" id="sobrenome" class=" form-control input-lg " placeholder="Last Name..." />
                      ...
                      <div class="input-group">
                        ...
                        <div class="label-sexo">
                            ...
                            <span class="label label-default">Gender</span><br><br>

                        </div>


                        <?php if($dados[0]['sexo'] == 1){ ?>
                          <div class="radio-sexo-feminino"><input value="1" type="radio" id="sexo" name="sexo" checked> Female<br></div>
                          <div class="radio-sexo-masculino"><input value="0" type="radio" id="sexo" name="sexo" > Male<br></div>
                        <?php } else { ?>
                          <div class="radio-sexo-feminino"><input value="1" type="radio" id="sexo" name="sexo" > Female<br></div>
                          <div class="radio-sexo-masculino"><input value="0" type="radio" id="sexo" name="sexo" checked> Male<br></div>
                        <?php } ?>
                      ...
                      <div class="input-group input-size-small-device">
                        ...
                        <input value="<?php echo $dados[0]['cidade']; ?>" id="cidade" name="cidade" type="text" class=" form-control input-lg " placeholder="City... " />
                      </div>
                      ...
                      <div class="input-group input-size-small-device">
                        ...
                        <input value="<?php echo $dados[0]['celular']; ?>" id="celular" name="celular" type="text" class=" form-control input-lg " placeholder="Cell phone...     Ex:081XXXXXXXXX " />
                      </div>
                      ...
                      <div class="input-group input-size-small-device">
                        ...
                        <input value="<?php echo $dados[0]['telefone']; ?>" id="telefone" name="telefone" type="text" class=" form-control input-lg " placeholder="Telephone...     Ex:081XXXXXXXX " />
                      </div>
                      ...
                      <div class="input-group btn-upload-imagem">
                        ...
                        <label class="btn btn-md btn-default btn-cor-estilo-escuro"><i class="material-icons">file_upload</i>
                          Picture <input type="file" name="imagemPerfil" id="imagemPerfil">
                        </label>
                  ...
                  <div class="footer text-center">
                    ...
                    <input id="btnSalvar" name="btnSalvar" class="btn-salvar btn btn-default  btn-lg btn-cor-estilo-escuro" type="submit" value="Save"/>
