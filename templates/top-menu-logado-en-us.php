  ...
  <div class="container">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="perfil-usuario.php">Profile</a></li>

        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Reports <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li class="divider"></li>
            <li><a href="meus-reports.php">My Reports</a></li>
            <li class="divider"></li>
            <li><a href="form-report-achado.php">New Report: Found Item</a></li>
            <li><a href="form-report-perdido.php">New Report: Lost Item </a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li class="divider"></li>
            <li><a href="meus-itens.php">My Items</a></li>
            <li class="divider"></li>
            <li><a href="form-adicionar-item.php">Add Item</a></li>
          </ul>
        </li>
      </ul>
      ...
      <p class="logado-como-texto navbar-text navbar-right">Logged as: <strong><?php echo $_SESSION['Lost_Found']["email"]?></strong></p>
