          ...
          <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
              ...
              <div class="card card-adicionar-item">
                ...
                <h2 class="title titulo-adicionar-item">Report: Found Item</h2>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8 col-md-offset-2 ">
                        ...
                        <div class="input-group input-size-small-device">
                          ...
                          <input name="titulo" id="formTitulo" type="text" class=" form-control input-lg " placeholder="Name/Title... Ex: Black Jacket" required />
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="input-group input-size-small-device">
                            ...
                            <textarea name="informacao" id="formInformacao" class="form-control" placeholder="Write a short text about the situation where the item was found. Ex: I was on a wooden bench, which is in metro station N 22, Sunday afternoon, approximately 3pm" rows="10"></textarea>
                          </div>
                          ...
                          <h3 class="title titulo-adicionar-item">Please Write the address where <strong>the Item</strong> was found.</h2>
                        ...
                        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC1jcQdqAcbQSi0yuUDshqpLiz-fPqQ3m8&signed_in=true&libraries=places&callback=initAutocomplete" async defer></script>
                          ...
                          <div class="input-group input-size-small-device">
                            ...
                            <input disabled="true" id="locality" name="cidade" type="text" class=" form-control input-lg " placeholder="City... Ex: New York City" required></input>
                          </div>
                          ...
                          <div class="input-group input-size-small-device">
                            ...
                            <input disabled="true" id="country" name="pais" type="text" class=" form-control input-lg " placeholder="Country... Ex: Brasil" required></input>
                          </div>
