...
CREATE TABLE IF NOT EXISTS `itens` (
  ...
  `idRelAchado` varchar(32) DEFAULT NULL,
  `idRelPerdido` varchar(32) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `relatorios_achados` (
  `id` varchar(32) NOT NULL,
  `idItem` varchar(32) NOT NULL,
  `idUsuario` int(11) NOT NULL,
  `mapsLocal` varchar(100) NOT NULL,
  `mapsLat` float NOT NULL,
  `mapsLng` float NOT NULL,
  `informacao` text,
  `data` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS `relatorios_perdidos` (
  `id` varchar(32) NOT NULL,
  `idItem` varchar(32) NOT NULL,
  `idUsuario` int(11) NOT NULL,
  `mapsLocal` varchar(100) NOT NULL,
...
--
-- Indexes for table `relatorios_achados`
--
ALTER TABLE `relatorios_achados`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `relatorios_perdidos`
--
